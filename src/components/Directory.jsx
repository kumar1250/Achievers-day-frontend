...
function ITBadge({ value }) {
  const isIT = (value || "").trim().toUpperCase().startsWith("IT");
  const theme = isIT
    ? "from-sky-100 to-blue-100 text-blue-700 ring-blue-200"
    : "from-amber-100 to-orange-100 text-amber-700 ring-amber-200";
  return (
    <span
      ...
      >
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="Search by Regd No, name, branch, or company"
            autoComplete="off"
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[900px] text-sm">
            <thead className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white text-left">
              <tr>
                <th className="px-4 py-2.5 font-medium whitespace-nowrap">Regd No</th>
                ...
                <th className="px-4 py-2.5 font-medium whitespace-nowrap">Gender</th>
                <th className="px-4 py-2.5 font-medium whitespace-nowrap">Company</th>
                <th className="px-4 py-2.5 font-medium whitespace-nowrap">IT / Non-IT</th>
                <th className="px-4 py-2.5 font-medium whitespace-nowrap">Salary (LPA)</th>
