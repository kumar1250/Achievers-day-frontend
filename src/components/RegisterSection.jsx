...
export default function RegisterSection({ onRegistered }) {
  ...
  return (
    <div id="register" className="space-y-5 sm:space-y-6 max-w-2xl mx-auto px-4 sm:px-0 font-['Sora']">
      {/* Search */}
      <form
        ...
        <div className="bg-white/[0.06] backdrop-blur-sm rounded-xl shadow-[0_18px_40px_-24px_rgba(0,0,0,0.55)] border border-white/10 p-4 sm:p-5">
          ...
          {student.already_registered ? (
            <div className="mt-4 space-y-3">
              <div className="bg-[#00B8A9]/10 border border-[#00B8A9]/30 text-[#5CE0D3] text-sm rounded-lg px-4 py-3">
                This student has already been registered for Achievers Day.
              </div>
              <button
                type="button"
                onClick={handleViewAcknowledgement}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#F4A100] text-[#14102B] text-sm font-bold px-5 py-2.5 rounded-lg hover:bg-[#FFC94A] transition"
              >
